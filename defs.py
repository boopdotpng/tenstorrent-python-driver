...
HOST_SYSMEM_SIZE = _align_up(FAST_SYSMEM_SIZE, PAGE_SIZE)
HOST_ISSUE_BASE = FastDispatch.HOST_UNRESERVED_OFF
HOST_ISSUE_SIZE = _align_up(FAST_ISSUE_SIZE, FastDispatch.PCIE_ALIGNMENT)
HOST_COMPLETION_BASE = HOST_ISSUE_BASE + HOST_ISSUE_SIZE
HOST_COMPLETION_SIZE = _align_up(FAST_COMPLETION_SIZE, FastDispatch.PCIE_ALIGNMENT)
...
DEV_CMDDAT_Q_BASE = _align_up(DEV_PREFETCH_Q_BASE + DEV_PREFETCH_Q_SIZE, FastDispatch.PCIE_ALIGNMENT)
DEV_SCRATCH_DB_BASE = _align_up(DEV_CMDDAT_Q_BASE + FastDispatch.PREFETCH_CMDDAT_Q_SIZE, FastDispatch.PCIE_ALIGNMENT)
